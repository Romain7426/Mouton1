...
struct C3DS {
  ...
  //CLoad3DS g_Load3ds; // L'objet pour charger un 3ds // RL: This is useless. 
  t3DModel g_3DModel; //là ou sont stocké les points // RL: This is a bunch of data arrays. 
  int g_ViewMode; //mode d'affichage // RL: Useless as far as I can tell. 
