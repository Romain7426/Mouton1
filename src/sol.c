...
static float CSol__GET_MAP_Z(const CSol * this, const float map_x, const float map_y) { 
...
static int CSol__init(CSol * this, const int global_map_i, const int global_map_j, const int over_spanning_w, const int over_spanning_h, const float lattice_to_map_scale_factor__z, const riemann_t * our_manifold, const char * z_filename, const char * texture_filename) { 
...
static void CSol__Life(const CSol * this) { 
  // RL: So far, nothing to be done. 
}; 


static CSol * CSol__make_content(CSol * this); 
static CSol * CSol__make(void); 
