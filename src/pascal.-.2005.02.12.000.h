...
typedef char *pvstring; // Ici, on n'a pas de limites de chaîne. Cependant,
       ...
       */
       typedef pvpointer pvarray; // Le tableau est dans la mémoire. 
                                  // Donc un tableau, c'est une adresse mémoire.
       /*
       struct pvrecord {
       ...
       */
       typedef pvpointer pvrecord; // Même chose, on met les records en mémoire.
       ...
       */
       // Même chose avec les procédures et les fonctions.
       // On met tout dans la mêmoire, ce qui permet d'obtenir leur adresse.
       // Ce qui oblige à les ajouter dans SVal.
       // Ensuite, pour la valeur de retour d'une fonction,
       // il faut créer une nouvelle DVal.     
