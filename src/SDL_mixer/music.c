...
#ifdef CMD_MUSIC
#include "SDL_mixer/music_cmd.h"
#endif
#ifdef WAV_MUSIC
#include "SDL_mixer/wavestream.h"
#endif
#ifdef MODPLUG_MUSIC
#include "SDL_mixer/music_modplug.h"
#endif
#ifdef MOD_MUSIC
#include "SDL_mixer/music_mod.h"
#endif
#ifdef MID_MUSIC
...
#    include "SDL_mixer/fluidsynth.h"
#  endif
...
#endif
#ifdef OGG_MUSIC
#include "SDL_mixer/music_ogg.h"
#endif
#ifdef MP3_MUSIC
#include "SDL_mixer/dynamic_mp3.h"
#endif
#ifdef MP3_MAD_MUSIC
#include "SDL_mixer/music_mad.h"
#endif
#ifdef FLAC_MUSIC
#include "SDL_mixer/music_flac.h"
#endif
...
/* Mixing function */
extern void music_mixer(void *udata, Uint8 *stream, int len); void music_mixer(void *udata, Uint8 *stream, int len)
{
	int left = 0;
...
extern int open_music(SDL_AudioSpec *mixer); int open_music(SDL_AudioSpec *mixer)
{
#ifdef WAV_MUSIC
...
extern void close_music(void);  void close_music(void)
{
	Mix_HaltMusic();
#ifdef CMD_MUSIC
